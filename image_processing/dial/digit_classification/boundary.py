# Extracts the boundary of the digit from the input images retrieved from the tally counter
import cv2
import numpy as np
import os
...
DATA_DIR_DIGITS = Path(ROOT_DIR + "\\data\\digits")
unknown_digits = os.listdir(DATA_DIR_DIGITS)
